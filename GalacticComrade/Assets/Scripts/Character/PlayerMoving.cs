...
public class PlayerMoving : MonoBehaviour {
    ...
    public float movementSpeed_ = 30;
    ...
    private void Update()
    {
        if (controlIsActive)
        {
            ...
            if (Input.GetMouseButton(0)) //if mouse button was pressed       
            {
                ...
                transform.position = Vector3.MoveTowards(transform.position, mousePosition, movementSpeed_ * Time.deltaTime);
            }
#endif
            ...
            if (Input.touchCount == 1) // if there is a touch
            {
                ...
                transform.position = Vector3.MoveTowards(transform.position, touchPosition, movementSpeed_ * Time.deltaTime);
            }
#endif
